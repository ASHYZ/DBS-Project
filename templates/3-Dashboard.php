    ...
    <div class="wrapper">
        <div class="row">
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-danger" style="color:black;">
        ...
        .bg-primary{
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-primary" style="color:black;">
        ...
        .bg-warning {
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-warning" style="color:black;" >
        ...
        .bg-vio{
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-vio" style="color:black;">
        ...
        .bg-success{
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-success" style="color:black;">
        ...
        .bg-yell{
            ...
            <div class="col-4 col-m-4 col-sm-4">
                <div class="card">
                    <div class="counter bg-yell" style="color:black;">
